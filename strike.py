...
STRIKE_FILE = "persistent_data/strike_data.json"
STRIKE_LIST_FILE = "persistent_data/strike_list.json"
STRIKE_ROLES_FILE = "persistent_data/strike_roles.json"
STRIKE_AUTOROLE_FILE = "persistent_data/strike_autorole.json"
...
class Strike(commands.Cog):
    ...
    async def strikegive(self, interaction: discord.Interaction, user: discord.Member):
        ...
        if not (is_admin(interaction.user) or has_any_role(interaction.user, strike_roles)):
