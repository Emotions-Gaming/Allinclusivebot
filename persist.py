...
# Wichtige persistente Dateien (anpassen falls nötig)
DATA_FILES = [
...
class PersistCog(commands.Cog):
    ...
    @app_commands.command(name="backupnow", description="Backup aller wichtigen Bot-Daten jetzt durchführen (Admin)")
    ...
    @app_commands.command(name="restorenow", description="Restore aller Bot-Daten aus Backup (Admin)")
